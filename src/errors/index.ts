...
export const ErrorCode = {
  ...
  REINDEX_INVALID_STRATEGY: 'REINDEX_INVALID_STRATEGY',
  REINDEX_INVALID_PROVIDER_ERROR_MODE: 'REINDEX_INVALID_PROVIDER_ERROR_MODE',
  ...
  INDEXING_INVALID_PROVIDER_ERROR_MODE: 'INDEXING_INVALID_PROVIDER_ERROR_MODE',

  RETRIEVAL_INPUT_EMPTY: 'RETRIEVAL_INPUT_EMPTY',
  RETRIEVAL_REQUIRES_QUERY_TEXT: 'RETRIEVAL_REQUIRES_QUERY_TEXT',
  RETRIEVAL_INVALID_QUERY_TEXT: 'RETRIEVAL_INVALID_QUERY_TEXT',
  ...
  RETRIEVAL_INVALID_TEMPORAL_WINDOW: 'RETRIEVAL_INVALID_TEMPORAL_WINDOW',
  RETRIEVAL_INVALID_CONFIDENCE: 'RETRIEVAL_INVALID_CONFIDENCE',
  RETRIEVAL_INVALID_TOKEN_BUDGET: 'RETRIEVAL_INVALID_TOKEN_BUDGET',
  RETRIEVAL_INVALID_STRATEGY: 'RETRIEVAL_INVALID_STRATEGY',
  RETRIEVAL_INVALID_MODE: 'RETRIEVAL_INVALID_MODE',
  RETRIEVAL_INVALID_QUERY_TEXT_MODE: 'RETRIEVAL_INVALID_QUERY_TEXT_MODE',
  RETRIEVAL_INVALID_TEMPORAL_ANCHOR: 'RETRIEVAL_INVALID_TEMPORAL_ANCHOR',
  RETRIEVAL_INVALID_FILTER: 'RETRIEVAL_INVALID_FILTER',
  RETRIEVAL_VECTOR_INDEX_NOT_READY: 'RETRIEVAL_VECTOR_INDEX_NOT_READY',

  SCORER_NO_USABLE_SIGNAL: 'SCORER_NO_USABLE_SIGNAL',
  SCORER_INVALID_OUTPUT: 'SCORER_INVALID_OUTPUT',
  SCORER_BATCH_LENGTH_MISMATCH: 'SCORER_BATCH_LENGTH_MISMATCH',
  SCORER_REQUIRES_BATCH_CONTEXT: 'SCORER_REQUIRES_BATCH_CONTEXT',
  RERANKER_ERROR: 'RERANKER_ERROR',
  RERANKER_INVALID_OUTPUT: 'RERANKER_INVALID_OUTPUT',
  RERANKER_BATCH_LENGTH_MISMATCH: 'RERANKER_BATCH_LENGTH_MISMATCH',
  TOKEN_COUNTER_ERROR: 'TOKEN_COUNTER_ERROR',
  TOKEN_COUNTER_INVALID_OUTPUT: 'TOKEN_COUNTER_INVALID_OUTPUT',
  SUPERSESSION_DEPTH_EXCEEDED: 'SUPERSESSION_DEPTH_EXCEEDED',
  NAMESPACE_OPERATION_LOCKED: 'NAMESPACE_OPERATION_LOCKED',
...
export class ValidationError extends TragetiError {
  ...
  constructor(errors: string[], context = 'Assertion') {
    super(ErrorCode.VALIDATION_ERROR, `${context} validation failed:\n${errors.join('\n')}`);
