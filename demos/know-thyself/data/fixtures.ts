...
const byEpisode: Record<string, { assertions: AssertionFixture[]; links: LinkFixture[] }> = {
  'kf-1': {
    assertions: [
      assertion({
        ...
        type: 'fact',
        content:
          'v0.1 retrieval used a weighted hybrid score combining semantic similarity, BM25 text search, and recency.',
        confidence: 0.94,
        ...
        citations: [
          citation(
            ...
            'kf-1',
            'sources/kf-1.md',
            'Retrieval combines vector distance, BM25 text search, and recency into a weighted hybrid score.',
          ),
        ],
      }),
      assertion({
      ...
      assertion({
        ...
        citations: [
          citation(
            ...
            'kf-1',
            'sources/kf-1.md',
            'Citations are not yet a structural requirement in v0.1; assertions can be written without citation rows.',
          ),
        ],
      }),
    ],
      ...
      assertion({
        ...
        citations: [
          citation(
            'c-a-kf-2-citations',
            'kf-2',
            'sources/kf-1..kf-2.md',
            'v0.2 adds citations as first-class assertion provenance and introduces trajectory retrieval over supersession chains.',
          ),
        ],
      }),
      assertion({
  ...
  'kf-3': {
    assertions: [
      assertion({
        ...
        type: 'update',
        content:
          'v0.3 phase 1 shapes store creation, retrieval, writing, and closing as asynchronous public operations.',
        confidence: 0.9,
        entityId: 'public-api',
        citations: [
          citation(
      ...
      assertion({
        ...
        citations: [
          citation(
            'c-a-kf-3-observability',
            'kf-3',
            'sources/kf-2..kf-3.md',
            'trageti starts treating observability and lifecycle as first-class library behavior.',
          ),
        ],
      }),
      assertion({
    ...
    links: [
      link({
        id: 'link-kf-3-observability',
        fromId: 'a-kf-3-observability',
        toId: 'a-kf-3-async',
  ...
  'kf-5': {
      ...
      assertion({
        ...
        citations: [
          citation(
            ...
            'kf-5',
            'sources/kf-4..kf-5.md',
            'Phase 3 moves indexing to the embedding provider boundary.',
          ),
        ],
      }),
      assertion({
    ...
    links: [
      link({
        id: 'link-kf-5-vectorless',
        fromId: 'a-kf-5-indexing',
        toId: 'a-kf-4-vectorless',
        linkType: 'deepens',
        validFrom: 5,
        sourceEpisodeId: 'kf-5',
      }),
    ],
  },
  'kf-6': {
    ...
    links: [
      link({
        id: 'link-kf-6-scoring',
        fromId: 'a-kf-6-routing',
        toId: 'a-kf-1-scoring',
        linkType: 'deepens',
        validFrom: 6,
        sourceEpisodeId: 'kf-6',
      }),
    ],
  },
  'kf-7': {
    assertions: [
      assertion({
        ...
        type: 'fact',
        content:
          'The v0.3.0 release gate updates package metadata, README, changelog, migration guidance, and verification docs.',
        confidence: 0.9,
        ...
        citations: [
          citation(
            'c-a-kf-7-release',
            'kf-7',
            'sources/kf-6..kf-7.md',
            'The commit updates package metadata, README, changelog, migration guidance, and the verification matrix.',
          ),
        ],
      }),
      assertion({
  ...
  'kf-8': {
    assertions: [
      assertion({
        ...
        type: 'update',
        content:
          'v0.3 remediation R1 changes retrieval to return a RetrievalResult envelope with metadata and applied signals.',
        confidence: 0.94,
    ...
    links: [
      link({
        id: 'link-kf-8-routing',
        fromId: 'a-kf-8-envelope',
        toId: 'a-kf-6-routing',
        linkType: 'deepens',
        validFrom: 8,
        sourceEpisodeId: 'kf-8',
      }),
    ],
  },
  'kf-9': {
    ...
    links: [
      link({
        id: 'link-kf-9-fk',
        fromId: 'a-kf-9-rename',
        toId: 'a-kf-8-fk-fail-closed',
        linkType: 'contextualizes',
        validFrom: 9,
        sourceEpisodeId: 'kf-9',
      }),
    ],
  },
  'kf-10': {
    assertions: [
      ...
      assertion({
        ...
        type: 'fact',
        content:
          'v0.3 polish corrects startup step order for schema preparation, extension loading, and migration checks.',
        confidence: 0.88,
        entityId: 'lifecycle',
        citations: [
          citation(
    ...
    links: [
      link({
        id: 'link-kf-10-snapshot',
        fromId: 'a-kf-10-snapshot',
        toId: 'a-kf-2-trajectory',
        linkType: 'deepens',
        validFrom: 10,
        sourceEpisodeId: 'kf-10',
      }),
      link({
        id: 'link-kf-10-graph',
        fromId: 'a-kf-10-graph',
        toId: 'a-kf-6-tiebreak',
        linkType: 'deepens',
        validFrom: 10,
        sourceEpisodeId: 'kf-10',
      }),
