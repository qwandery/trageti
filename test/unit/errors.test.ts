...
describe('TragetiError hierarchy', () => {
  it('NamespaceNotInitializedError carries the right code and name', () => {
  ...
  it('NamespaceHashCollisionError reports both namespaces and table', () => {
  ...
  it('SchemaExtensionError exposes violations array', () => {
  ...
  it('ValidationError exposes errors array', () => {
  ...
  it('MigrationError captures version and underlying cause', () => {
  ...
  it('MigrationError stringifies non-Error causes', () => {
    const err = new MigrationError(3, 'plain string cause')
    expect(err.message).toContain('plain string cause')
  })

  it('ConnectionVerificationError carries the right code', () => {
