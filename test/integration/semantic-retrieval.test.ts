...
describe('TemporalStore — semantic retrieval', () => {
  ...
  beforeEach(() => {
    ...
    store.indexAssertion('a-future', VEC_C)
  })

  it('returns most semantically similar assertions at anchor', () => {
  ...
  it('excludes assertions with validFrom > temporalAnchor', () => {
    const results = store.retrieve({
      namespace: NS,
      queryEmbedding: QUERY_NEAR_A,
      temporalAnchor: 5,
  ...
  it('scoreComponents are always populated', () => {
    const results = store.retrieve({
      namespace: NS,
      queryEmbedding: QUERY_NEAR_A,
      temporalAnchor: 5,
  ...
  it('FTS5 path: queryText populates bm25Score in scoreComponents', () => {
    const results = store.retrieve({
      namespace: NS,
      queryEmbedding: QUERY_NEAR_A,
      queryText: 'Alpha',
  ...
  it('custom scorer override is used for ranking', () => {
  ...
  it('returns empty array when no indexed assertions exist at anchor', () => {
    const results = store.retrieve({
      namespace: NS,
      queryEmbedding: QUERY_NEAR_A,
      temporalAnchor: 0,
  ...
  it('graph expansion attaches linked assertions', () => {
    store.writeLink({ id: 'l-1', namespace: NS, fromId: 'a-early', toId: 'a-mid', linkType: 'related', validFrom: 1, validUntil: null, sourceEpisodeId: 'ep-1' })
    const results = store.retrieve({
      namespace: NS,
      queryEmbedding: QUERY_NEAR_A,
      temporalAnchor: 5,
...
describe('TemporalStore — retrieve returns typed RetrievedAssertion', () => {
  it('returned objects have all Assertion fields plus score and scoreComponents', () => {
    const db = openTestDb()
