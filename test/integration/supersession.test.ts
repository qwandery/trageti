...
describe('TemporalStore — supersession', () => {
  ...
  beforeEach(() => {
    ...
    store.writeAssertion({ id: 'a-1', namespace: NS, type: 'fact', content: 'Original claim.', validFrom: 1, validUntil: null, confidence: 1, sourceEpisodeId: 'ep-1', supersedesId: null, entityId: 'entity-x', entityType: 'concept' })
  })
  ...
  it('supersedeAssertion with replacedById links successor', () => {
    store.writeAssertion({ id: 'a-2', namespace: NS, type: 'fact', content: 'Updated claim.', validFrom: 5, validUntil: null, confidence: 1, sourceEpisodeId: 'ep-5', supersedesId: 'a-1', entityId: 'entity-x', entityType: 'concept' })
  ...
  it('rejects cross-namespace replacedById', () => {
    ...
    store.writeAssertion({ id: 'a-other', namespace: NS2, type: 'fact', content: 'Other ns claim.', validFrom: 1, validUntil: null, confidence: 1, sourceEpisodeId: 'ep-other', supersedesId: null, entityId: null, entityType: null })
